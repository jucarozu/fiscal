...
var CargaInformacionService_1 = require("../../../../services/CargaInformacionService");
...
var CargaInformacionComponent = (function () {
    function CargaInformacionComponent(router, authService, cargaInformacionService, auditoriaService, notificationService) {
        this.router = router;
        this.authService = authService;
        this.cargaInformacionService = cargaInformacionService;
    ...
    CargaInformacionComponent.prototype.ngOnInit = function () {
    ...
    CargaInformacionComponent.prototype.agregarEventos = function () {
    ...
    CargaInformacionComponent.prototype.cargarCombos = function () {
        this.caracteres = [
            { "nombre": ",", "valor": "," },
            { "nombre": ";", "valor": ";" },
            { "nombre": "|", "valor": "|" },
        ...
        this.camposValidos = [
            ...
            { "nombre": "Lic transito", "valor": "lic_transito" },
            { "nombre": "Divipo OT", "valor": "divipo_ot" },
            { "nombre": "Nombre OT", "valor": "nombre_ot" },
            { "nombre": "Cod Clase", "valor": "cod_clase" },
            { "nombre": "Clase", "valor": "clase" },
            { "nombre": "Cod Servicio", "valor": "cod_servicio" },
            { "nombre": "Servicio", "valor": "servicio" },
            { "nombre": "Cod Radio Accion", "valor": "cod_radio_accion" },
            { "nombre": "Radio Accion", "valor": "radio_accion" },
            { "nombre": "Cod Modalidad", "valor": "cod_modalidad" },
            { "nombre": "Modalidad", "valor": "modalidad" },
            { "nombre": "Cod Tipo Pasajeros", "valor": "cod_tipo_pasajeros" },
            { "nombre": "Tipo Pasajeros", "valor": "tipo_pasajeros" }
        ];
    };
    CargaInformacionComponent.prototype.cargarPlano = function () {
    ...
    CargaInformacionComponent.prototype.visualizarContenidoPlano = function () {
    ...
    CargaInformacionComponent.prototype.procesarInformacion = function () {
        var _this = this;
        ...
        this.isLoading = true;
        var cargaInformacionString = this.generarCargaInformacionString(this.campos, this.filas);
        this.cargaInformacionService.insert(cargaInformacionString).then(function (res) {
    ...
    CargaInformacionComponent.prototype.validarCampos = function () {
    ...
    CargaInformacionComponent.prototype.generarCargaInformacionString = function (campos, filas) {
    ...
    CargaInformacionComponent.prototype.descargarResultado = function () {
    ...
    CargaInformacionComponent.prototype.exportInformacionToCSV = function (jsonEncabezados, jsonFilas) {
        var data = [];
        var csvContent = "";
        if (this.tieneEncabezados) {
    ...
    CargaInformacionComponent.prototype.exportAdvertenciasToCSV = function (jsonAdvertencias) {
        var data = [];
        var csvContent = "";
    ...
    CargaInformacionComponent.prototype.exportErroresToCSV = function (jsonErrores) {
        var data = [];
        var csvContent = "";
    ...
    CargaInformacionComponent.prototype.resetFormulario = function () {
    ...
    CargaInformacionComponent.prototype.resetUploader = function () {
        this.uploader.clearQueue();
    };
    CargaInformacionComponent.prototype.loading = function () {
        return this.isLoading;
    };
    CargaInformacionComponent = __decorate([
        core_1.Component({
            selector: 'carga-informacion-view',
            templateUrl: './app/components/src/administracion/carga-informacion/carga-informacion-view.html',
            bindings: [AuthService_1.AuthService, CargaInformacionService_1.CargaInformacionService, AuditoriaService_1.AuditoriaService, components_1.NotificationsService],
            directives: [
        ...
        __metadata('design:paramtypes', [router_deprecated_1.Router, AuthService_1.AuthService, CargaInformacionService_1.CargaInformacionService, AuditoriaService_1.AuditoriaService, components_1.NotificationsService])
    ], CargaInformacionComponent);
    return CargaInformacionComponent;
}());
exports.CargaInformacionComponent = CargaInformacionComponent;
//# sourceMappingURL=CargaInformacionComponent.js.map