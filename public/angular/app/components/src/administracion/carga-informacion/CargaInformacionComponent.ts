...
import { CargaInformacionService } from "../../../../services/CargaInformacionService";
...
@Component({
    ...
    bindings: [AuthService, CargaInformacionService, AuditoriaService, NotificationsService],
    directives: [
...
export class CargaInformacionComponent implements OnInit
{
    ...
    private procesarInformacion()
    {
        ...
        let cargaInformacionString = this.generarCargaInformacionString(this.campos, this.filas);
 
        this.cargaInformacionService.insert(cargaInformacionString).then(
            (res) => {
    ...
    private generarCargaInformacionString(campos, filas) : string
    {
        var i = 0,
            j = 0,
            keys = [],
