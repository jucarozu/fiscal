...
var AuditoriaService = (function () {
    function AuditoriaService(http) {
        this.http = http;
        this.url = URL_APP_1.URL_APP + "seguridad/auditoria/";
    ...
    AuditoriaService.prototype.get = function () {
        return this.http.get(this.url + "api/")
            .toPromise()
            .then(function (res) { return res.json().registrosAuditoria; });
    };
    AuditoriaService.prototype.insert = function (opcion, accion, peticion) {
        var registroAuditoria = "usuario=" + this.userLogin.usuario
            + "&opcion=" + opcion
            + "&accion=" + accion
